...
class GeneticOptimizer:
    def __init__(self, distance_matrix, pop_size=50, elite_size=10, mutation_rate=0.01, generations=100):
    ...
    def rank_routes(self, population):
        ...
        # Returns a list of (index, distance) tuples sorted by distance
        fitness_results = {}
    ...
    def selection(self, pop_ranked):
        ...
        for _ in range(len(pop_ranked) - self.elite_size):
            ...
            winner = pick_1 if self.route_distance(self.population[pick_1]) < self.route_distance(self.population[pick_2]) else pick_2
